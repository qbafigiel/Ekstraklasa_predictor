...
def scrape_mecz(p, flash_id, url):
    """Scrapuje jeden mecz w izolowanej sesji Firefoksa. Zwraca słownik ze statystykami."""
        ...
        try:
            ...
            if browser is not None:
                try:
                    ...
                    pass
    return {"flash_id": flash_id, "url": url}, False
...
if __name__ == "__main__":
    ...
    with sync_playwright() as p:
        for nr, (flash_id, url) in enumerate(MECZE):
            ...
            stat, sukces = scrape_mecz(p, flash_id, url)
            wyniki.append(stat)
